...
@Component({
    ...
    templateUrl:'app/pages/openchannelmanagementlist/home.html',
    providers: [AppCommonservices]
    //directives: [FORM_DIRECTIVES, REACTIVE_FORM_DIRECTIVES]
})
export class AppOpenchannelmanagementlist {
    ...
    deleterow(adminid:any){
        ...
        let link= this.serverUrl+'deleteopenchannel';
        let id=adminid;
        this.http.post(link,id)
            .subscribe(data1 => {
                ...
                this.appcomponent.putmessages('Open Channel '+adminid.channelname+' deleted successfully','success');
                //console.log(this.data);
   ...
   let stat={id:item._id,is_active:is_active};
       let link= this.serverUrl+'openchannelstatuschange';
