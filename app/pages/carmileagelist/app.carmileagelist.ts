...
@Component({
    ...
    templateUrl:'app/pages/carmileagelist/home.html',
    providers: [AppCommonservices]
    //directives: [FORM_DIRECTIVES, REACTIVE_FORM_DIRECTIVES]
})
export class AppCarmileagelist {
    ...
    constructor(fb: FormBuilder , http:Http ,commonservices: AppCommonservices,userInfo:CookieService,router: Router,appcomponent:AppComponent  ) {
        ...
        let link = this.serverUrl+'listcarautomileage';
        this.p=1;
    ...
    deleterow(dealerrow:any){
        ...
        let link= this.serverUrl+'deletecarautomilage';
        let id=dealerrow;
        this.http.post(link,id)
            .subscribe(data1 => {
                ...
                console.log(this.data);
                 this.appcomponent.putmessages('Mileage '+dealerrow.mileage+' deleted successfully','success');
                //console.log(this.data);
    ...
    changeStatus(item:any){
        ...
        let link= this.serverUrl+'updatecarautomilagestatus';
