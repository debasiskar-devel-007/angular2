...
@Component({
    ...
    templateUrl:'app/pages/colorlist/home.html',
    providers: [AppCommonservices]
    //directives: [FORM_DIRECTIVES, REACTIVE_FORM_DIRECTIVES]
})
export class AppColorlist {
    ...
    constructor(fb: FormBuilder , http:Http ,commonservices: AppCommonservices,userInfo:CookieService,router: Router,appcomponent:AppComponent  ) {
        ...
        let link = this.serverUrl+'colorlist';
        this.p=1;
    ...
    deleterow(dealerrow:any){
        ...
        let link= this.serverUrl+'deletecolor';
        let id=dealerrow;
        this.http.post(link,id)
            .subscribe(data1 => {
                ...
                console.log(this.data);
                 this.appcomponent.putmessages('Color '+dealerrow.color+' deleted successfully','success');
                //console.log(this.data);
    ...
    changeStatus(item:any){
        ...
        let link= this.serverUrl+'colorstatuschange';
