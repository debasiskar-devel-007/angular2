...
@Component({
    ...
    templateUrl:'app/pages/ongoingauctionscustomer/home.html',
    providers: [AppCommonservices]
    //directives: [FORM_DIRECTIVES, REACTIVE_FORM_DIRECTIVES]
})
export class AppOngoingauctionscustomer{
    ...
    /*getauctiondate(val:any){
        var s:any;
        for(s in this.auctionlistarr){
            if(this.auctionlistarr[a]._id==val.color) return this.colorlist[a].color;
        }
        return 'N/A';
