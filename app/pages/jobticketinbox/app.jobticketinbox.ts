...
@Component({
    ...
    templateUrl:'app/pages/jobticketinbox/home.html',
    providers: [AppCommonservices]
    //directives: [FORM_DIRECTIVES, REACTIVE_FORM_DIRECTIVES]
})
export class AppJobticketinbox {
           ...
           // console.log(this.userInfo.username);
            ...
            for (x in this.data) {
                ...
                if(this.userInfo.userrole=='dealer') {
                    if (this.data[x].to == this.userInfo.username || this.data[x].from == this.userInfo.username) {
