...
@Component({
    ...
    templateUrl:'app/pages/purchasetimelist/home.html',
    providers: [AppCommonservices]
    //directives: [FORM_DIRECTIVES, REACTIVE_FORM_DIRECTIVES]
})
export class AppPurchasetimelist {
    ...
    constructor(fb: FormBuilder , http:Http ,commonservices: AppCommonservices,userInfo:CookieService,router: Router,appcomponent:AppComponent  ) {
        ...
        let link = this.serverUrl+'purchasetimelist';
        this.p=1;
    ...
    deleterow(dealerrow:any){
        ...
        let link= this.serverUrl+'deletepurchasetime';
        let id=dealerrow;
        this.http.post(link,id)
            .subscribe(data1 => {
                ...
                console.log(this.data);
                 this.appcomponent.putmessages('Purchase time '+dealerrow.name+' deleted successfully','success');
                //console.log(this.data);
    ...
    changeStatus(item:any){
        ...
        let link= this.serverUrl+'purchasetimestatuschange';
