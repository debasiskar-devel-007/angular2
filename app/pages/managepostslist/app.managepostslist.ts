...
@Component({
    ...
    templateUrl:'app/pages/managepostslist/home.html',
    providers: [AppCommonservices]
    //directives: [FORM_DIRECTIVES, REACTIVE_FORM_DIRECTIVES]
})
export class AppManagepostslist{
    ...
    constructor(@Inject(Renderer) private renderer: Renderer,fb: FormBuilder , http:Http ,commonservices: AppCommonservices,userInfo:CookieService,router: Router,appcomponent:AppComponent,private _sanitizer: DomSanitizer  ) {
        ...
        this.orderbytype=-1;
       // var link=this.serverUrl+'managepostlistall';
        var link=this.serverUrl+'managepostlist';
        var user={dealerusername:this.userdetails.username}
       // this.http.get(link)
    ...
    deleterow(dealerrow:any){
        ...
        let link= this.serverUrl+'deletemanagepost';
        let id=dealerrow;
        this.http.post(link,id)
            .subscribe(data1 => {
               ...
               // console.log(this.data);
                ...
                this.appcomponent.putmessages('Manage posts '+dealerrow.title+' deleted successfully','success');
                //console.log(this.data);
   ...
   let stat={id:item._id,is_active:is_active};
       let link= this.serverUrl+'managepoststatuschange';
