import {Component, NgModule, ViewChild,ViewContainerRef, ViewEncapsulation,OnInit,ElementRef, NgZone} from '@angular/core';
...
export class AppManageopencontract {
    ...
    constructor(fb: FormBuilder , http:Http ,commonservices: AppCommonservices ,userdetails:CookieService ,router: Router,elementRef: ElementRef,appcomponent:AppComponent) {
        ...
        this.http.get(this.serverUrl+'opencontractlist?dealeridn='+this.userDetails.id)
            .subscribe(data => {
                //console.log(data);
                this.contractlist=data.json();
    ...
    updateformsubmit(){
        ...
        if(this.addbannersizeformnew.valid){
            ...
            let link22 = this.serverUrl+'addopencontract';
            ...
            this.http.post(link22,submitdata1)
                .subscribe(data => {
                    ...
                    $('.new_adminblockwrapper').addClass('hide');
