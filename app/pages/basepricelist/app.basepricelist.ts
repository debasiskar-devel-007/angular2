...
@Component({
    ...
    templateUrl:'app/pages/basepricelist/home.html',
    providers: [AppCommonservices]
    //directives: [FORM_DIRECTIVES, REACTIVE_FORM_DIRECTIVES]
})
export class AppBasepricelist {
    ...
    constructor(fb: FormBuilder , http:Http ,commonservices: AppCommonservices,userInfo:CookieService,router: Router,appcomponent:AppComponent  ) {
        ...
        let link = this.serverUrl+'basepricelist';
        this.p=1;
        this.orderbyquery='baseprice';
        this.orderbytype=-1;
        this.http.get(link)
            .subscribe(data1 => {
    ...
    deleterow(dealerrow:any){
        ...
        let link= this.serverUrl+'deletebaseprice';
        let id=dealerrow;
        this.http.post(link,id)
            .subscribe(data1 => {
                ...
                console.log(this.data);
                 this.appcomponent.putmessages('Base price '+dealerrow.baseprice+' deleted successfully','success');
                //console.log(this.data);
    ...
    changeStatus(item:any){
        ...
        let link= this.serverUrl+'basepricestatuschange';
